...
mod tests {
    ...
    fn test_format_legend() {
        ...
        map.users.insert("@john.doe".to_string(), "@user1".to_string());
        map.channels.insert("#general".to_string(), "#ch1".to_string());
        map.emails.insert("test@example.com".to_string(), "user1@domain1.com".to_string());
